...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className='mb-3'>
        I'm a recent graduate from the University of California, Los Angeles,
        where I majored in <span className='font-medium'>Computer Science</span>
        . My journey in software engineering spans from designing and
        implementing solutions to testing and deploying them. I have a
      ...
      <p>
        ...
        engineering began with my first smartphone, and I've been dedicated to
        contributing to the technology industry ever since.
      </p>
    </motion.section>
  );
}
